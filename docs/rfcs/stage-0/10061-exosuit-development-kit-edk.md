<!-- exo:10061 ulid:01kmzxefesz01c1p7nncwps11p -->
...
-   **Reactive Bindings**: Signals for VS Code APIs (RFC 0031).
...
-   **Semver Strictness**: We follow a strict "Train Model" (see RFC 0045).
