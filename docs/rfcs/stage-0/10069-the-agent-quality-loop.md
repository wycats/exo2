<!-- exo:10069 ulid:01kmzxeffhc372jp2w7fvqss4b -->
...
*   *Anti-Pattern*: Blocking the agent for missing a tag.
*   *Pattern*: Suggesting relevant tags based on the current epoch.
...
*   *Anti-Pattern*: `Task started.` (Zero context).
*   *Pattern*: `[Mission] Task started. Remember: In this Epoch, we value "Glitch Freedom".`
...
*   *Anti-Pattern*: "Upload a screenshot to prove you did it."
*   *Pattern*: "Show me what you built. If I were reviewing this PR, what would make me say 'Wow'?"
...
*   **Prompting**: Instead of generic "Description", the CLI asks specific, pride-oriented questions based on the entry type.
    *   *Feature*: "What is the 'North Star' user experience of this feature?"
    *   *Refactor*: "How did you leave the code better than you found it?"
    *   *Fix*: "How did you prove the bug is dead?"
