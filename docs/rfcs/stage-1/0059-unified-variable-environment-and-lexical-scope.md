<!-- exo:59 ulid:01kmzxey0yt9d867zxzaw435yr -->
...
Expansion is supported in the task system (including RFC 0058 recipe tasks):
...
3) Validate the argv for unsupported shell operators as required by the caller (e.g., RFC 0058).
