<!-- exo:110 ulid:01kg5kp2ggbf5hp9kfy340mkw2 -->
...
- **The Bridge**:
  - Communication happens _only_ via message passing (JSON-serializable payloads).
...
- **Documentation**: Updates the relevant stabilized architecture RFCs to reflect the strict separation.
