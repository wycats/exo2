<!-- exo:10162 ulid:01kmzxbcybr6a9x65p29pe5qtq -->
...
- **Related**: RFC 0020 (Sidebar Navigation)

## Summary

The Exosuit UI Architecture defines how the agent and project state are presented to the user within VS Code. It expands upon the original "Sidebar" concept (RFC 0020) to include a multi-view Dashboard and a custom "Studio" editor for rich context files.
