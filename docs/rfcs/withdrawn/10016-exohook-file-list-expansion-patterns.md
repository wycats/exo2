<!-- exo:10016 ulid:01kmzxbczfv8gf5z1ra63n9x57 -->
...
When a check consumes `paths`, `exohook` must define _exactly_ where and how the list appears. A minimal, teachable model:
