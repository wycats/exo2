<!-- exo:10109 ulid:01kmzxbd09ajbhgwpm4jccmjhx -->
...
- **Reliability**: As we move core agent logic into Rust (RFC 0028), the tooling becomes critical path. It must be reliable.
