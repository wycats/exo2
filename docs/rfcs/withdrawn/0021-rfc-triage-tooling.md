<!-- exo:21 ulid:01kg5kp2by5ghrqsp7mhc6rnbz -->

# RFC 21: RFC Triage Tooling (The Gardener)

- **Supersedes**: RFC 10142
...
- **Orphaned**: Not linked to project planning state or other RFCs.
...
- RFCs are promoted to Stage 1 but never added to canonical project planning state.
- Phases are defined in canonical project planning state but lack the RFCs that define them.

**The Solution (`exo rfc triage --planning`)**:
This mode analyzes the relationship between `docs/rfcs/` and canonical project planning state.
