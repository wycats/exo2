<!-- exo:10095 ulid:01kmzxefe628mstsvh3ak44733 -->
...
A recent "Gap Analysis" revealed a discrepancy between the "Ideal Tool" (and the promises of RFC 0031) and the "Current Reality" of the `exo` CLI.
