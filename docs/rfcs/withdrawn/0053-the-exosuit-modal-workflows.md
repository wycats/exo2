<!-- exo:53 ulid:01kg5kp2djd9n0z10141mktv6x -->
...
*   **Entropy**: A subtle "Health" indicator (Green/Yellow/Red).
    *   *Integration*: Linked to the **Context Inbox** (RFC 0016). Red status indicates critical items in the Inbox.
